...
{errors.email && (
  <p className="text-red-500">{errors.email.message}</p>
          ...
          <label className="block text-gray-700 pt-2">
          ...
          <div className="relative flex items-center justify-center w-full mt-5">
            ...
            <div className="absolute px-2 text-lg text-primary-900 bg-white">
              OR
            </div>
          </div>
          ...
          <button
            type="button"
            className="relative flex items-center justify-center w-full h-14 px-4 py-4 mt-5 text-base font-medium text-white bg-primary-900 hover:bg-primary-400 border border-transparent rounded-md group focus:ring-indigo-500"
          >
      ...
      <div className="mt-4">
        <p className="text-gray-700">
          Already an account? <span className="text-[#FF6637]">SIGN IN</span>
        </p>
      </div>
    </div>
  );
