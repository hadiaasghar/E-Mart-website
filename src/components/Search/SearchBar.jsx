        ...
        <div className="mb-4">
          <div className="relative w-full">
            ...
            <button className="absolute top-0 right-0 mt-3 mr-2">
              <FaSearch className="mx-4 text-primary-500" />
            </button>
          </div>
        </div>
        <button className="bg-primary-900 p-2 rounded font-bold flex items-center gap-2">
          <IoHomeOutline /> All Restaurant ({filteredRestaurants.length})
        </button>
