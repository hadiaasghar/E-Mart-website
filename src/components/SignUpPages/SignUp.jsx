    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <button 
            type="button" 
            className="relative flex items-center justify-center w-full h-14 px-4 py-4 mt-5 text-base font-medium text-white bg-primary-900 hover:bg-primary-400 border border-transparent rounded-md group h focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
