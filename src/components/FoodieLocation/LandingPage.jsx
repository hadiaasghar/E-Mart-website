...
import logo from "../../../public/E-Market-logo.png";
      ...
      <div className="overflow-hidden flex flex-col-reverse md:flex-row justify-between items-center  ">
        <div className="relative md:w-1/2 flex flex-col gap-5">
          ...
          <div className="px-4 md:px-20 py-5 flex flex-col gap-5">
            <img src={logo} alt="E-market Logo" className="w-48" />
            ...
            <form className="relative flex items-center w-full">
              <input
                ...
                className="w-full px-4 py-3 bg-white rounded-md border border-primary-200 focus:outline-none focus:border-primary-500"
                value={location}
                onChange={(e) => setLocation(e.target.value)}
              />
              <button
                type="button"
                className="absolute right-3 inset-y-0 flex items-center text-gray-600 hover:text-gray-800 text-primary-600 font-bold"
            ...
            <div>
              <button
                className="bg-primary-600 text-white px-4 py-2 rounded-md mt-4 hover:bg-primary-900"
